...
export default function HomepageSecondaryCta() {
  return (
    <motion.section
      className="bg-white pt-24 pb-24 lg:pt-32 lg:pb-32 relative "
    ...
    >
      <div className="lg:max-w-[1200px] max-w-[95%] lg:px-8  mx-auto w-full items-center flex flex-col gap-6 lg:gap-12 relative px-4">
        <div className="flex flex-col items-center gap-4 mb-4 bg-offwhite rounded-4xl lg:p-0 p-8 lg:rounded-full lg:py-24 w-full">
